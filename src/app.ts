...
export interface AppDependencies { config: AppConfig; blockchain: BlockchainClient; wallet: TradingWallet; walletAddress?: Address; balances?: BalanceService; trades: TradeService; perps: PaperPerpsService; db?: DatabaseRepository | CidoDatabaseRepository; authService?: AuthService; }
